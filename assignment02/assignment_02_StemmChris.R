...
## Use `setwd()` if needed
setwd("/Users/Chris Stemm/Documents/GitHub/520")

## Load the file `data/tidynomicon/person.csv` to `person_df1` using `read.csv`
## Examine the structure of `person_df1` using `str()`
person_df1 <- read.csv("/Users/Chris Stemm/Documents/GitHub/520/data/tidynomicon/person.csv")
str(person_df1)
...
person_df2 <- read.csv("/Users/Chris Stemm/Documents/GitHub/520/data/tidynomicon/person.csv")
str(person_df2)

## Read the file `data/scores.csv` to `scores_df`
## Display summary statistics using the `summary()` function
scores_df <- read.csv("/Users/Chris Stemm/Documents/GitHub/520/data/scores.csv")
cols <- sapply(scores_df, is.character)
scores_df[cols] <- lapply(scores_df[cols], factor)
summary(scores_df)
...
excel_sheets("/Users/Chris Stemm/Documents/GitHub/520/data/G04ResultsDetail2004-11-02.xls")
...
voter_turnout_df1 <- read_excel("/Users/Chris Stemm/Documents/GitHub/520/data/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout", skip = 1)
...
voter_turnout_df2 <- read_excel("/Users/Chris Stemm/Documents/GitHub/520/data/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout", skip = 2, col_names = c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout"))
...
db <- dbConnect(RSQLite::SQLite(), "/Users/Chris Stemm/Documents/GitHub/520/data/tidynomicon/example.db")
